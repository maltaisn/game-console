...
INSTR_WRITE = 0x02
INSTR_ERASE = {
    4096: EraseInstruction(0x20, 0.06),
...
class FlashDriver(MemoryDriver):
    ...
    def reset(self):
        ...
        if id_num != MANUFACTURER_ID:
            raise CommError("Flash device manufacturer and device ID do not match predefined value")
    ...
    def erase(self, progress: ProgressCallback) -> None:
        """Erase whole device."""
        self.erase_blocks(0, FLASH_SIZE, [(0, FLASH_SIZE)], progress)
